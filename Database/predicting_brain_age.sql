...
--
-- Database: `predicting_brain_age`
--
CREATE DATABASE IF NOT EXISTS `predicting_brain_age` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
--
-- Table structure for table `remote_user_brain_age_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_brain_age_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_brain_age_prediction`
--

INSERT INTO `remote_user_brain_age_prediction` (`id`, `idno`, `gender`, `age`, `hypertension`, `heart_disease`, `ever_married`, `work_type`, `Residence_type`, `avg_glucose_level`, `bmi`, `smoking_status`, `Prediction`) VALUES
(5, '10434', 'Female', '69', '0', '0', 'No', 'Private', 'Urban', '94.39', '22.8', 'never smoked', 'Long Age'),
(6, '53882', 'Male', '74', '1', '1', 'Yes', 'Private', 'Rural', '70.09', '27.4', 'never smoked', 'Short Age'),
(9, '70630', 'Female', '71', '0', '0', 'Yes', 'Govt_job', 'Rural', '193.94', '22.4', 'smokes', 'Short Age');
...
(1, 'Suresh', 'Suresh123@gmail.com', 'Suresh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,rajajinagar', 'Male'),
(3, 'tmksmanju', 'tmksmanju13@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,8th Cross,Rajajjinagar', 'Male');
...
(101, 'SVM', '64.9706457925636'),
(102, 'Logistic Regression', '66.43835616438356'),
(103, 'Decision Tree Classifier', '63.405088062622305'),
(104, 'KNeighborsClassifier', '66.43835616438356');
...
(19, 'Short Age', '66.66666666666666'),
(20, 'Long Age', '33.33333333333333');
