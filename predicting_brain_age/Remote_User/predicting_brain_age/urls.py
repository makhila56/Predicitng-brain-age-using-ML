"""predicting_brain_age URL Configuration
...
urlpatterns = [
    ...
    url(r'^Predict_BrainAge_Type/$', remoteuser.Predict_BrainAge_Type, name="Predict_BrainAge_Type"),
    ...
    url(r'^View_BrainAge_Type_Ratio/$', serviceprovider.View_BrainAge_Type_Ratio, name="View_BrainAge_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Brain_Age_Type/$', serviceprovider.View_Prediction_Of_Brain_Age_Type, name="View_Prediction_Of_Brain_Age_Type"),
